try {
    ...
    var itemFSL = ['😍', '🌹', '恭喜上了王者呀', '下次记得带我去密室逃脱', '下次一起去看樱花呗', '多吃多睡', '你的头像有什么含义，可以偷偷的告诉我呀', '有趣的事分享给我也高兴高兴😁', '我希望你每天都能够开开心心呀！', '选择自己所爱的，爱自己所选择的！', '每天晚上要像zhu一样睡得香，哈哈！', '外出注意安全，晚上尽量不要一个人外出呗！', '每天按时吃饭、按时起床睡觉。', '有什么烦恼就要记得和我说呀', '同甘共苦！', '未来可期！', '天冷记得加衣！', '有机会晚上可以试着泡泡jio', '有幸遇见你！', '我们一起加油！', '笑一个呗', '看看今天是我们相识多长时间了', '遇见你是最美好的意外！', '你看到我送你的这个礼物第一感觉是什么？', '相信我们！', '乖，摸摸头！', '慢慢更多的理解家人']
